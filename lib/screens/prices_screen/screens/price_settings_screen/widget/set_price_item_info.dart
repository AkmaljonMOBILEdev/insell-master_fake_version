...
class SetPriceItemInfo extends StatefulWidget {
  const SetPriceItemInfo({super.key});

  @override
  State<SetPriceItemInfo> createState() => _SetPriceItemInfoState();
}

class _SetPriceItemInfoState extends State<SetPriceItemInfo> {
  @override
