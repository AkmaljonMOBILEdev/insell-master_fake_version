...
class SupplierRegionSide extends StatefulWidget {
  const SupplierRegionSide({
    super.key,
    this.hideToolBar,
  ...
  @override
  State<SupplierRegionSide> createState() => _SupplierRegionSideState();
}

class _SupplierRegionSideState extends State<SupplierRegionSide> {
                ...
                children: [
                  AppButton(
                    ...
                    child: const Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                      Text('Region Qo\'shish', style: TextStyle(color: Colors.white)),
                    ]),
                  ),
                  AppButton(
                    onTap: toggleTreeView,
                    hoverRadius: BorderRadius.circular(10),
                    child: Icon(!isExpandAll ? Icons.open_in_full : Icons.close_fullscreen,
                        color: AppColors.appColorWhite, size: 20),
                  ),
                ],
              ),
            ),
                    ...
                    child: DragTarget<RegionData>(
                      builder: (context, candidateData, rejectedData) {
                        return RegionListItem(
                          onAddButton: widget.onAddButton,
