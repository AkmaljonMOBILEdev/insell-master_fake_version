...
class PayToOtherConsumptionScreen extends StatefulWidget {
  const PayToOtherConsumptionScreen({Key? key}) : super(key: key);

  @override
  State<PayToOtherConsumptionScreen> createState() => _PayToOtherConsumptionScreenState();
}

class _PayToOtherConsumptionScreenState extends State<PayToOtherConsumptionScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Boshqa xarajatlar', style: TextStyle(color: AppColors.appColorWhite)),
        centerTitle: false,
      ),
      body: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        ...
                        child:
                        FutureBuilder(
                          future: HttpServices.get("/consumption/other-expense/all"),
