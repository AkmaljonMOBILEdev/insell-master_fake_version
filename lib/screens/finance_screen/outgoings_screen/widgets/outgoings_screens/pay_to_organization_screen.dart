...
class PayToOrganizationScreen extends StatefulWidget {
  const PayToOrganizationScreen({Key? key}) : super(key: key);

  @override
  State<PayToOrganizationScreen> createState() => _PayToOrganizationScreenState();
}

class _PayToOrganizationScreenState extends State<PayToOrganizationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Organizatsiyaga to\'lov', style: TextStyle(color: AppColors.appColorWhite)),
        centerTitle: false,
      ),
      body: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        ...
                        child:
                        FutureBuilder(
                          future: HttpServices.get("/consumption/organization-consumption/all"),
