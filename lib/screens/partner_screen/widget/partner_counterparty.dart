...
class PartnerCounterparty extends StatefulWidget {
  const PartnerCounterparty({super.key, required this.type, required this.callback});

  final String type;
  final VoidCallback callback;

  @override
  State<PartnerCounterparty> createState() => _PartnerCounterpartyState();
}

class _PartnerCounterpartyState extends State<PartnerCounterparty> {
  bool loading = false;
            ...
            child: loading
                ...
                : Column(
                    children: [
                      ...
                      FutureBuilder(
                        future: HttpServices.get("/counterparty/partner/all"),
