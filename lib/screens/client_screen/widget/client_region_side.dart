...
class ClientRegionSide extends StatefulWidget {
  const ClientRegionSide({
    super.key,
    this.hideToolBar,
  ...
  @override
  State<ClientRegionSide> createState() => _ClientRegionSideState();
}

class _ClientRegionSideState extends State<ClientRegionSide> {
